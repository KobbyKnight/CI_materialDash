<footer class="footer">
	...
	<div class="fixed-plugin">
		<div class="dropdown show-dropdown">
            ...
            <li class="button-container">
				...
				<li class="button-container">
					<a href="https://demos.creative-tim.com/material-dashboard-dark/docs/2.0/getting-started/introduction.html" target="_blank"
	...
	<script async defer src="<?php echo base_url('assets/js/plugins/buttons.js')?>"></script>
	<!--  Google Maps Plugin    -->
